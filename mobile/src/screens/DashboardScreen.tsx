...
import { View, Text, FlatList, TouchableOpacity, Image, Share, Alert, Pressable, Animated, Modal, TextInput, ScrollView, Platform, Linking, useWindowDimensions, StyleSheet } from 'react-native';
